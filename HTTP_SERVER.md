# PostgreSQL MCP Server - HTTP/Streamable Transport

This server now supports the **Streamable HTTP** transport from MCP SDK 1.26.0, which is a modern HTTP-based protocol that supports:
